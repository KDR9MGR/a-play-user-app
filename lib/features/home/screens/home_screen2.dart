          ...
          TargetContent(
            ...
            builder: (context, controller) {
              return _buildTutorialContent(
                ...
                description: "Find events, clubs, and restaurants quickly using our smart search feature.",
                step: "1 of 4",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
            onRefresh: () async {
              // Invalidate all providers to trigger loading states and shimmer effects
