...
mixin _$RestaurantBooking {
  ...
  DateTime get updatedAt =>
      throw _privateConstructorUsedError; // Payment fields (added 2026-03-21)
...
// Additional fields for UI (not stored in DB)
  ...
  @override
  String toString() {
    return 'RestaurantBooking(id: $id, userId: $userId, restaurantId: $restaurantId, tableId: $tableId, bookingDate: $bookingDate, startTime: $startTime, endTime: $endTime, partySize: $partySize, status: $status, specialRequests: $specialRequests, contactPhone: $contactPhone, totalAmount: $totalAmount, createdAt: $createdAt, updatedAt: $updatedAt, transactionId: $transactionId, paymentStatus: $paymentStatus, paymentMethod: $paymentMethod, paymentReference: $paymentReference, amountPaid: $amountPaid, currency: $currency, table: $table, restaurantName: $restaurantName, userName: $userName)';
  }
...
abstract class _RestaurantBooking implements RestaurantBooking {
  ...
  @JsonKey(name: 'updated_at')
  DateTime get updatedAt;
  @override // Payment fields (added 2026-03-21)
  @JsonKey(name: 'transaction_id')
