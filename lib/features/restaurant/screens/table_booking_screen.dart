...
class _TableBookingScreenState extends ConsumerState<TableBookingScreen> {
  ...
  Future<void> _confirmBooking() async {
    ...
    try {
      // Calculate deposit amount (20% of estimated total)
      // Assuming GH₵100 base rate per table + GH₵50 per person
      final estimatedTotal = 100.0 + (partySize * 50.0);
      final depositAmount = estimatedTotal * 0.20; // 20% deposit
      ...
      if (mounted) {
        ...
        context.goNamed(
          ...
          extra: {
            ...
            'tableId': selectedTable.id,
            'tableName': '${selectedTable.tableNumber} (${selectedTable.tableType.displayName})',
